...
parser.add_argument(
    "--int4-convrot-compile-precision",
    action="store_true",
    help="Preserve eager precision around compiled INT4 ConvRot operators (enables Inductor force_same_precision and emulate_precision_casts)",
)
